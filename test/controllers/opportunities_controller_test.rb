...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { contact: @opportunity.contact, image: @opportunity.image, location: @opportunity.location, name: @opportunity.name }
    end
  ...
  test "should update opportunity" do
    patch :update, id: @opportunity, opportunity: { contact: @opportunity.contact, image: @opportunity.image, location: @opportunity.location, name: @opportunity.name }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
